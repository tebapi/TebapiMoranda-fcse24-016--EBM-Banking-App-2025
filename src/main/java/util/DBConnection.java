...
public class DBConnection {
    ...
    private static void initializeDatabase() {
        ...
        try (Connection conn = getConnection();
            ...
            // Use regular strings instead of text blocks
    ...
    private static void insertSampleData(Statement stmt) throws SQLException {
        ...
        // Use regular strings for insert statements
        String insertAdmin = "INSERT OR IGNORE INTO users (user_id, username, password, user_type, email) " +
                "VALUES (1, 'admin', 'admin123', 'ADMIN', 'admin@ebmbank.com')";

        String insertEmployee = "INSERT OR IGNORE INTO users (user_id, username, password, user_type, email) " +
                "VALUES (2, 'employee1', 'emp123', 'EMPLOYEE', 'employee@ebmbank.com')";

        String insertEmployeeDetails = "INSERT OR IGNORE INTO employees (employee_id, first_name, last_name, department, position) " +
                "VALUES (2, 'John', 'Smith', 'Customer Service', 'Bank Teller')";

        String insertCustomer = "INSERT OR IGNORE INTO users (user_id, username, password, user_type, email) " +
                "VALUES (3, 'customer1', 'cust123', 'CUSTOMER', 'customer@email.com')";

        String insertCustomerDetails = "INSERT OR IGNORE INTO customers (customer_id, first_name, last_name, email, phone, employment_status) " +
                "VALUES (3, 'Alice', 'Johnson', 'alice@email.com', '1234567890', 'Employed')";

        String insertSavingsAccount = "INSERT OR IGNORE INTO accounts (account_number, customer_id, account_type, balance, branch, interest_rate) " +
                "VALUES ('SAV-123456', 3, 'Savings', 5000.00, 'Main Branch', 0.0005)";

        String insertChequeAccount = "INSERT OR IGNORE INTO accounts (account_number, customer_id, account_type, balance, branch, interest_rate) " +
                "VALUES ('CHQ-789012', 3, 'Cheque', 2500.00, 'Main Branch', 0.0)";

        String insertInvestmentAccount = "INSERT OR IGNORE INTO accounts (account_number, customer_id, account_type, balance, branch, interest_rate) " +
                "VALUES ('INV-345678', 3, 'Investment', 10000.00, 'Main Branch', 0.05)";

        String insertTransaction1 = "INSERT OR IGNORE INTO transactions (account_number, transaction_type, amount, description, performed_by) " +
                "VALUES ('SAV-123456', 'DEPOSIT', 5000.00, 'Initial account opening deposit', 2)";

        String insertTransaction2 = "INSERT OR IGNORE INTO transactions (account_number, transaction_type, amount, description, performed_by) " +
                "VALUES ('CHQ-789012', 'DEPOSIT', 2500.00, 'Initial account opening deposit', 2)";

        String insertTransaction3 = "INSERT OR IGNORE INTO transactions (account_number, transaction_type, amount, description, performed_by) " +
